...
The mean of HbA1c when adjusted to district variance was `r round(fixef(lmemodnull),2)`, which was a bit higher than average HbA1c regardless of the district effect (7.75 - refer demographic table)

The mean of HbA1c for each district was shown below
...
Between Daerah variance: `r round(as.data.frame(VarCorr(lmemodnull))[1,4],2)`, and within School variance: `r round(as.data.frame(VarCorr(lmemodnull))[2,4],2)`.
...
Between Daerah variance: `r round(as.data.frame(VarCorr(lmemodRI))[1,4],2)`, and within School variance: `r round(as.data.frame(VarCorr(lmemodRI))[2,4],2)`.
...
Between Daerah variance: `r round(as.data.frame(VarCorr(lmemodRS))[1,4],2)`, and within School variance: `r round(as.data.frame(VarCorr(lmemodRS))[4,4],2)`.
