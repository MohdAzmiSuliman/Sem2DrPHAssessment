...
pdcds1 <- pdcds0 %>%
  ...
  select(GenderCode, RaceCode, Age, MethodCode, Dateofplacement, Dateofremoval, Comorbidities, ComorbidYesNo, CMDM, CMHPT, CMIHD, CxCode, TypeofComplication, CxEarlyLate14Code, CxEarlyLate14TypeCode, CxEarlyLate30Code, CxEarly30YesNo, CxLate30YesNo, CxEarlyLate30TypeCode, ExitSiteIfxCode) 
pdcds1
```
