...
data.frame(cbind(newds, predmod)) %>%
  ...
  select(Gender, Age, CMDM, Method, "Predicted Complication Time (Days) - Q1", "Predicted Complication Time (Days) - Median", "Predicted Complication Time (Days) - Q3") %>% datatable()
```
...
data.frame(cbind(newds, removal_predmod)) %>%
  ...
  select(Gender, Age, CMDM, Method, "Predicted Removal Time (Days) - Q1", "Predicted Removal Time (Days) - Median", "Predicted Removal Time (Days) - Q3") %>% datatable()
```
